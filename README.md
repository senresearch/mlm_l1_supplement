...
- [`woodruff_sim.jl`](code/woodruff_sim.jl): run LU+2081-penalized matrix linear model
...
- [`lowry.jl`](code/lowry.jl): run LU+2081-penalized matrix linear model
